 ...
 <div id="pesanan" class="pesanan">
 	<div class="container">
 		<div class="row mt-5">
					...
					<div class="row">
						...
						<div class="row no-gutters">
						  <div class="card-body">
						    <div class="row">
						       <div class="col-lg-2">
						        <img src="<?= base_url('assets/images/') . $p['image']; ?>" class="card-img">
						        </div>
						        	<div class="col-lg-3 d-flex align-items-center">
						        	<div class="item">
						        	<h5 class="card-title"><?= $p['food']; ?></h5>
			...
			<div class="col-lg-3">
				<div class="card shadow bg-dark text-white info-bayar" style="width: 100%; padding-left: 15px; padding-right: 14px;">
				<div class="row">
				...
				<div class="row">
					<div class="col mb-4 mt-1 ">
						<a href="<?= base_url('pesanan/bayar/') . $no_pesanan; ?>" id="bayar" class="btn btn-pesan text-white" style="width: 100%;">Bayar</a>
					</div>
				</div>
				<?php endif; ?>
				</div>
