  ...
  <body>
    ...
    <!-- Navbar -->
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
          <a class="navbar-brand" href="<?= base_url(); ?>">CAFE INFORMATIC</a>
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
            <div class="navbar-nav">
              ...
              <a class="nav-item nav-link active" href="<?= base_url('pesanan'); ?>">Pesanan </a>
              <?php else : ?>
              <a class="nav-item nav-link" href="<?= base_url('pesanan'); ?>">Pesanan </a>
            
              <?php endif; ?>   
               <?php if ($title == 'AboutUs') : ?>
                <a class="nav-item nav-link active mr-3" href="<?= base_url('AboutUs'); ?>">About Us</a>
              <?php else : ?>
                <a class="nav-item nav-link mr-3" href="<?= base_url('AboutUs'); ?>">About Us</a>
              <?php endif; ?>           
            </div>
          </div>
        </div>
